    ...
    <nav className="sticky top-0 z-50 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md shadow-md border-b border-slate-100 dark:border-slate-800 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20 items-center">
          ...
          >
            <div className="w-11 h-11 bg-gradient-to-tr from-[#800000] to-rose-900 rounded-xl flex items-center justify-center text-white font-bold text-xl group-hover:scale-105 transition-all shadow-md">
              <span className="text-[#87CEEB] text-xs font-extrabold uppercase">PFC</span>
            </div>
  ...
  const slides = [
    {
      ...
      img: "https://images.unsplash.com/photo-1438032005730-c779502df39b?auto=format&fit=crop&w=1600&q=80"
    },
    {
      title: "Join the Family Service",
      sub: "Sunday Second Service 9:00 AM — 1:30 PM",
      img: "https://images.unsplash.com/photo-1544427920-c49ccfb85579?auto=format&fit=crop&w=1600&q=80"
    },
    {
      title: "Wednesday Fellowship",
      sub: "Midweek Spiritual Recharge from 5:00 PM",
      img: "https://images.unsplash.com/photo-1445445290350-18a3b86e0b5b?auto=format&fit=crop&w=1600&q=80"
    }
  ];
...
const About = () => (
  <div className="animate-in fade-in duration-500">
    <PageHeader title="Who We Are" subtitle="Raising a royal priesthood built on truth and apostolic mandate." />
    <div className="max-w-7xl mx-auto px-4 py-20 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
      <div className="space-y-6">
        <h2 className="text-3xl font-extrabold text-[#800000] dark:text-[#87CEEB] uppercase">The Apostolic Call</h2>
          ...
          {[
            ...
            "Equipping The Youth Frontier"
             ...
             <div key={i} className="flex items-center gap-3 text-slate-700 dark:text-slate-200 font-bold">
               <CheckCircle className="text-[#800000] dark:text-[#87CEEB]" size={18} />
               <span>{item}</span>
             </div>
          ))}
        </div>
      </div>
      <div className="bg-slate-900/10 dark:bg-slate-800 rounded-2xl h-96 flex items-center justify-center shadow-inner relative overflow-hidden">
        <img 
          src="https://images.unsplash.com/photo-1438232992991-995b7058bbb3?auto=format&fit=crop&w=800&q=80" 
          alt="Altar Sanctuary" 
          className="w-full h-full object-cover opacity-60"
        />
        <div className="absolute inset-0 bg-gradient-to-tr from-[#800000]/30 to-[#87CEEB]/10" />
      </div>
    </div>
  </div>
);

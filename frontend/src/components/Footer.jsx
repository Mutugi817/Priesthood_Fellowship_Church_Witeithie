...
const Footer = () => {
  ...
  return (
    <footer className="bg-slate-900 text-slate-300 py-16 border-t-4 border-[#800000]">
      ...
      <div className="flex items-center text-center justify-between max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 pt-8 border-t border-slate-800 text-slate-500 text-sm flex-col">
        ...
        <p className='text-xs hover:text-[#448ee4] transition-colors'>
          <a href="tel:+254115793480">Contact developer: 0115 793 480</a>
        </p>
      </div>
    </footer>
  );

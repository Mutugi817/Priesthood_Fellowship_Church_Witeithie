...
const HeroSlider = () => {
  ...
  return (
    <div className="relative h-[90vh] min-h-125 w-full overflow-hidden bg-[#0e498df0]">
      {slides.map((s, idx) => (
        <div 
          key={idx}
        ...
        >
          ...
          <div className="hero-content absolute inset-0 flex flex-col justify-end pd-8 items-center px-4 text-center max-w-5xl mx-auto z-10">
            ...
            <h1 className="text-4xl sm:text-5xl font-extrabold text-white tracking-tight m-b-2 select-none uppercase ">
              {s.title}
            </h1>

...
const Navbar = () => {
  ...
  return (
    <nav className="fixed md:sticky w-full top-0 z-50 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md shadow-md border-b border-slate-100 dark:border-slate-800 transition-colors duration-300">
        ...
        <div className="flex justify-between h-20 items-center">
          ...
          >
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[0.5rem] md:text-[0.8rem] text-slate-500 dark:text-slate-400 font-semibold tracking-widest">CHURCH WITEITHIE BRANCH</span>
            </div>
          </div>
